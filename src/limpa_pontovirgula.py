...
tabela= pd.read_csv("/home/matheus_mai/Desktop/dbNSFP4.2a/newCUT_chr21", sep= "\t", low_memory=False)

#tabela.drop(['Unnamed: 74', 'Unnamed: 75', 'Unnamed: 76', 'Unnamed: 77', 'Unnamed: 78', 'Unnamed: 79', 'Unnamed: 80'], axis=1, inplace=True)
...
df.columns= ['#chr', 'pos(1-based)', 'ref', 'alt', 'aaref', 'aaalt', 'rs_dbSNP',
       'hg19_chr', 'hg19_pos(1-based)', 'aapos', 'genename', 'HGVSc_ANNOVAR',
       ...
       'HUVEC_confidence_value', 'LINSIGHT', 'GERP++_RS', '1000Gp3_AF',
       '1000Gp3_AFR_AF', '1000Gp3_EUR_AF', '1000Gp3_AMR_AF', '1000Gp3_EAS_AF',
       '1000Gp3_SAS_AF', 'gnomAD_exomes_flag', 'gnomAD_exomes_AF',
       'gnomAD_exomes_AFR_AF', 'gnomAD_exomes_AMR_AF', 'gnomAD_exomes_ASJ_AF',
       'gnomAD_exomes_EAS_AF', 'gnomAD_exomes_FIN_AF', 'gnomAD_exomes_NFE_AF',
       'gnomAD_exomes_SAS_AF', 'clinvar_id', 'clinvar_clnsig', 'clinvar_trait',
       'clinvar_var_source']

df= df.astype(object)
df.to_csv('/home/matheus_mai/Desktop/dbNSFP4.2a/chr21.csv', index= False)
